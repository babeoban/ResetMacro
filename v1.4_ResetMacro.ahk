...
; Macro setting
global logFolder = "D:\MultiMC\instances\mc1\.minecraft\logs"
...
SetKeyDelay, 0
IfNotExist, %logFolder% 
{
    MsgBox, You have not set your Minecraft instance log folder
    ExitApp
}
if (wideResets) {
...
while (True) {
  numLines := 0
  Loop, Read, %logFolder%\latest.log
  {
    numLines += 1
  }
  preview := False
